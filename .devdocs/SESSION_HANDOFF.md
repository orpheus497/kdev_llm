...
* **Modified Files**: src/context/ContextManager.cpp, src/ui/AiChatInputWidget.h, src/ui/AiChatInputWidget.cpp, tests/CMakeLists.txt, tests/TestCommandTextEdit.cpp, tests/TestContextManager.cpp, tests/TestLlamaClient.cpp, CMakeLists.txt, src/CMakeLists.txt, README.md, tests/mocks/*.
